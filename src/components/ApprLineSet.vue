            ...
            <div class="table-area">
                <div class="table-b">
                    <div class="table-header">
                        ...
                        <div class="btn-wrap btn-type1 clearfix fl_right" style="padding-right: 195px">
                    ...
                    <div id="treeBox" style="width:300px;height:350px;float:left; border-top:1px solid #c7c7c7; border-bottom:1px solid #c7c7c7; border-left:1px solid #c7c7c7; border-right:1px solid #c7c7c7;"></div>
            ...
            return {
                config : {
                    columns: [
                        ...
                        {id: 'jobGradeNm', type: 'ro', align: 'center', sort: 'na', value: '직급'},
                ...
                configLine : {
                    columns: [
                        ...
                        {id: 'jobNm', type: 'ro', align: 'center', sort: 'na', value: '직책'},
